...
#   BUILD_OS           OS to build for (note that manually overriding this will
#                       not affect the Mozilla build system, and is untested;
#                       this variable is meant to provide convenient OS
